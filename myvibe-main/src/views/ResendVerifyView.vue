<template>
	<section class="auth">
		<div class="container">
			...
			<h1 class="title mb-4">Resend Email Verify!</h1>
			<!-- <small class="d-block mb-4">My <span class="highlight">Vibe</span></small> -->
			<form autocomplete="off" @submit.prevent="resendVerify">
				<div class="mb-3">
...
export default {
	...
	methods: {
		async resendVerify() {
			this.loading = true;
			try {
				const response = await authService.resendVerify({
					email: this.email
				});
